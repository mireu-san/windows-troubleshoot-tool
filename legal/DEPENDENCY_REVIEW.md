...
- The previous `2026.09.13` release lacks the new embedded notice viewer and contains the bootstrapper. The reviewed replacement is version `2026.09.14`; build and ZIP checksums are recorded in [build-verification.json](build-verification.json). Historical assets are not silently replaced.
