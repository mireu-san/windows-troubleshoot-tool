...
func TestCheckAppUpdate(t *testing.T) {
	for _, tc := range []struct {
		...
		{"September 12 to release", "2026.09.12", releaseJSON("v2026.09.14", "WindowsSystemRepairHelper.exe", "github.com"), 200, true, true, false},
		{"September 13 to release", "2026.09.13", releaseJSON("v2026.09.14", "WindowsSystemRepairHelper.exe", "github.com"), 200, true, true, false},
